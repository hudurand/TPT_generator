...
def test_get_shareclass_infos(data_bucket, reference_TPT_report):
    ...
    assert reference_TPT_report["1_Portfolio identifying data"].iloc[0] == shareclass_infos.name
...
def test_get_instruments_infos(data_bucket, reference_TPT_report):
    ...
    ref = reference_TPT_report.sort_index()
...
def test_fill_column_1(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["1_Portfolio identifying data"].sort_index()
    ref = reference_TPT_report["1_Portfolio identifying data"].sort_index()
...
def test_fill_column_2(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["2_Type of identification code for the fund share or portfolio"].sort_index()
    ref = reference_TPT_report["2_Type of identification code for the fund share or portfolio"].sort_index()
...
def test_fill_column_3(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["3_Portfolio name"].sort_index()
    ref = reference_TPT_report["3_Portfolio name"].sort_index()
...
def test_fill_column_4(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["4_Portfolio currency (B)"].sort_index()
    ref = reference_TPT_report["4_Portfolio currency (B)"].sort_index()
...
def test_fill_column_5(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["5_Net asset valuation of the portfolio or the share class in portfolio currency"].sort_index()
    ref = reference_TPT_report["5_Net asset valuation of the portfolio or the share class in portfolio currency"].sort_index()
...
def test_fill_column_6(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["6_Valuation date"].sort_index()
    ref = reference_TPT_report["6_Valuation date"].sort_index()
...
def test_fill_column_7(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["7_Reporting date"].sort_index()
    ref = reference_TPT_report["7_Reporting date"].sort_index()
...
def test_fill_column_8(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["8_Share price"].sort_index()
    ref = reference_TPT_report["8_Share price"].sort_index()
...
def test_fill_column_8b(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["8b_Total number of shares"].sort_index()
    ref = reference_TPT_report["8b_Total number of shares"].sort_index()
...
def test_fill_column_9(generator, reference_TPT_report):
    ...
    prod = pd.to_numeric(generator.TPT_report[r"9_% cash"].sort_index()).round(5)
    ref = pd.to_numeric(reference_TPT_report[r"9_% cash"].sort_index()).round(5)

    diff1 = prod.loc[~(prod.index.isin(reference_TPT_report.index))]
    print(diff1)
    diff2 = ref.loc[~(reference_TPT_report.index.isin(prod.index))]
    print(diff2)
...
def test_fill_column_10(generator, reference_TPT_report):
    ...
    #breakpoint()
    prod = generator.TPT_report.sort_index()
    ref = reference_TPT_report.sort_index()
...
def test_fill_column_54(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["54_Economic sector"].sort_index()
    ref = reference_TPT_report["54_Economic sector"].sort_index()
...
def test_fill_column_61(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["61_Strike price"].sort_index().fillna(0).round(4)
    ref = reference_TPT_report["61_Strike price"].sort_index().fillna(0).round(4)
...
def test_fill_column_115(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["115_Fund Issuer Code"].sort_index()
    ref = reference_TPT_report["115_Fund Issuer Code"].sort_index()
...
def test_fill_column_116(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["116_Fund Issuer Code Type"].sort_index()
    ref = reference_TPT_report["116_Fund Issuer Code Type"].sort_index()
...
def test_fill_column_117(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["117_Fund Issuer Name"].sort_index()
    ref = reference_TPT_report["117_Fund Issuer Name"].sort_index()
...
def test_fill_column_118(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["118_Fund Issuer Sector"].sort_index()
    ref = reference_TPT_report["118_Fund Issuer Sector"].sort_index()
...
def test_fill_column_119(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["119_Fund Issuer Group Code"].sort_index()
    ref = reference_TPT_report["119_Fund Issuer Group Code"].sort_index()
...
def test_fill_column_120(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["120_Fund Issuer Group Code Type"].sort_index()
    ref = reference_TPT_report["120_Fund Issuer Group Code Type"].sort_index()
...
def test_fill_column_121(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["121_Fund Issuer Group name"].sort_index()
    ref = reference_TPT_report["121_Fund Issuer Group name"].sort_index()
...
def test_fill_column_122(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["122_Fund Issuer Country"].sort_index()
    ref = reference_TPT_report["122_Fund Issuer Country"].sort_index()
...
def test_fill_column_123(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["123_Fund CIC code"].sort_index()
    ref = reference_TPT_report["123_Fund CIC code"].sort_index()
...
def test_fill_column_123a(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["123a_Fund Custodian Country"].sort_index()
    ref = reference_TPT_report["123a_Fund Custodian Country"].sort_index()
...
def test_fill_column_124(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["124_Duration"].sort_index()
    ref = reference_TPT_report["124_Duration"].sort_index()
...
def test_fill_column_125(generator, reference_TPT_report):
    ...
    prod = pd.to_numeric(generator.TPT_report["125_Accrued Income (Security Denominated Currency)"].sort_index()).round(5)
    ref = pd.to_numeric(reference_TPT_report["125_Accrued Income (Security Denominated Currency)"].sort_index()).round(5)
...
def test_fill_column_133(generator, reference_TPT_report):
    ...
    prod = generator.TPT_report["133_custodian_name"].sort_index()
    ref = reference_TPT_report["133_custodian_name"].sort_index()
