...
from TPT_generator_python import TPTFetcher
from TPT_generator_python import TPTGenerator
from TPT_generator_python import DataBucket
...
@pytest.fixture(scope="module")
def reference_report(params_fixt):
    """
...
def test_get_shareclass_infos(data_bucket, reference_report):
    """
    ...
    assert reference_report["1_Portfolio identifying data"].iloc[0] == shareclass_infos.name
        

def test_get_subfund_infos(data_bucket, reference_report):
    """
    ...
    assert subfund_infos["subfund_lei"].iloc[0] == \
        reference_report["115_Fund Issuer Code"].iloc[0]

def test_get_fund_infos(data_bucket, reference_report):
    """
    ...
    assert fund_infos["fund_issuer_group_code"].iloc[0] == reference_report["119_Fund Issuer Group Code"].iloc[0]
...
def test_get_shareclass_nav(data_bucket, params_fixt):
    ...
    assert shareclass_nav["nav_date"] == DATE

def test_get_instruments(data_bucket, reference_report):
    """
...
def test_get_instruments_infos(data_bucket, reference_report):
    """
...
def test_create_empty_report(generator, reference_report):
    
    generator.create_empty_report()
    #print(reference_report.info)
    assert generator.report.shape == reference_report.shape
    assert_index_equal(generator.report.columns, reference_report.columns)

def test_fill_column_1(generator, reference_report):

    generator.fill_column_1()
    prod = generator.report["1_Portfolio identifying data"].sort_index()
    ref = reference_report["1_Portfolio identifying data"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_2(generator, reference_report):

    generator.fill_column_2()

    prod = generator.report["2_Type of identification code for the fund share or portfolio"].sort_index()
    ref = reference_report["2_Type of identification code for the fund share or portfolio"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_3(generator, reference_report):

    generator.fill_column_3()

    prod = generator.report["3_Portfolio name"].sort_index()
    ref = reference_report["3_Portfolio name"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_4(generator, reference_report):

    generator.fill_column_4()
    prod = generator.report["4_Portfolio currency (B)"].sort_index()
    ref = reference_report["4_Portfolio currency (B)"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_5(generator, reference_report):

    generator.fill_column_5()
    prod = generator.report["5_Net asset valuation of the portfolio or the share class in portfolio currency"].sort_index()
    ref = reference_report["5_Net asset valuation of the portfolio or the share class in portfolio currency"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_6(generator, reference_report):

    generator.fill_column_6()
    prod = generator.report["6_Valuation date"].sort_index()
    ref = reference_report["6_Valuation date"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_7(generator, reference_report):

    generator.fill_column_7()
    prod = generator.report["7_Reporting date"].sort_index()
    ref = reference_report["7_Reporting date"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_8(generator, reference_report):

    generator.fill_column_8()
    prod = generator.report["8_Share price"].sort_index()
    ref = reference_report["8_Share price"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_8b(generator, reference_report):

    generator.fill_column_8b()
    prod = generator.report["8b_Total number of shares"].sort_index()
    ref = reference_report["8b_Total number of shares"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_9(generator, reference_report):

    generator.fill_column_9()
    
    prod = pd.to_numeric(generator.report[r"9_% cash"].sort_index()).round(5)
    ref = pd.to_numeric(reference_report[r"9_% cash"].sort_index()).round(5)

    diff1 = prod.loc[~(prod.index.isin(reference_report.index))]
    print(diff1)
    diff2 = ref.loc[~(reference_report.index.isin(prod.index))]
    print(diff2)
...
def test_fill_column_10(generator, reference_report):
...
def test_fill_column_11(generator, reference_report):
...
def test_fill_column_12(generator, reference_report):
...
def test_fill_column_13(generator, reference_report):
...
def test_fill_column_14(generator, reference_report):

    generator.fill_column_14()

    column = generator.report["14_Identification code of the financial instrument"].sort_values()
    column = column.reset_index(drop=True)
    ref = reference_report["14_Identification code of the financial instrument"].sort_values()
    ref = ref.reset_index(drop=True)
    assert_series_equal(column, ref)

def test_fill_column_15(generator, reference_report):
...
def test_fill_column_16(generator, reference_report):
...
def test_fill_column_17(generator, reference_report):
...
def test_fill_column_18(generator, reference_report):
...
def test_fill_column_20(generator, reference_report):
...
def test_fill_column_21(generator, reference_report):
...
def test_fill_column_22(generator, reference_report):
...
def test_fill_column_23(generator, reference_report):
...
def test_fill_column_24(generator, reference_report):
...
def test_fill_column_25(generator, reference_report):
...
def test_fill_column_28(generator, reference_report):
...
def test_fill_column_29(generator, reference_report):
...
def test_fill_column_30(generator, reference_report):
...
def test_fill_column_31(generator, reference_report):
...
def test_fill_column_32(generator, reference_report):
...
def test_fill_column_33(generator, reference_report):
...
def test_fill_column_34(generator, reference_report):
...
def test_fill_column_35(generator, reference_report):
...
def test_fill_column_36(generator, reference_report):
...
def test_fill_column_37(generator, reference_report):
...
def test_fill_column_38(generator, reference_report):
...
def test_fill_column_39(generator, reference_report):
...
def test_fill_column_40(generator, reference_report):
...
def test_fill_column_41(generator, reference_report):
...
def test_fill_column_42(generator, reference_report):
...
def test_fill_column_43(generator, reference_report):
...
def test_fill_column_44(generator, reference_report):
...
def test_fill_column_45(generator, reference_report):
...
def test_fill_column_46(generator, reference_report):
...
def test_fill_column_47(generator, reference_report):
...
def test_fill_column_48(generator, reference_report):
...
def test_fill_column_49(generator, reference_report):
...
def test_fill_column_50(generator, reference_report):
...
def test_fill_column_51(generator, reference_report):
...
def test_fill_column_52(generator, reference_report):
...
def test_fill_column_53(generator, reference_report):
...
def test_fill_column_54(generator, reference_report):

    generator.fill_column_54()
    
    prod = generator.report["54_Economic sector"].sort_index()
    ref = reference_report["54_Economic sector"].sort_index()
...
def test_fill_column_55(generator, reference_report):
...
def test_fill_column_56(generator, reference_report):
...
def test_fill_column_57(generator, reference_report):
...
def test_fill_column_58(generator, reference_report):
...
def test_fill_column_58b(generator, reference_report):
...
def test_fill_column_61(generator, reference_report):

    generator.fill_column_61()
    
    prod = generator.report["61_Strike price"].sort_index().fillna(0).round(4)
    ref = reference_report["61_Strike price"].sort_index().fillna(0).round(4)
...
def test_fill_column_62(generator, reference_report):
...
def test_fill_column_63(generator, reference_report):
...
def test_fill_column_64(generator, reference_report):
...
def test_fill_column_65(generator, reference_report):
...
#def test_fill_column_66(generator, reference_report):
#
#    generator.fill_column_62()
#    
#    prod = generator.report.sort_index()
...
def test_fill_column_67(generator, reference_report):
...
def test_fill_column_68(generator, reference_report):
...
def test_fill_column_69(generator, reference_report):
...
def test_fill_column_70(generator, reference_report):
...
def test_fill_column_71(generator, reference_report):
...
def test_fill_column_72(generator, reference_report):
...
def test_fill_column_73(generator, reference_report):
...
def test_fill_column_74(generator, reference_report):
...
def test_fill_column_75(generator, reference_report):
...
def test_fill_column_76(generator, reference_report):
...
def test_fill_column_77(generator, reference_report):
...
def test_fill_column_78(generator, reference_report):
...
def test_fill_column_79(generator, reference_report):
...
def test_fill_column_80(generator, reference_report):
...
def test_fill_column_81(generator, reference_report):
...
def test_fill_column_82(generator, reference_report):
...
def test_fill_column_83(generator, reference_report):
...
def test_fill_column_84(generator, reference_report):
...
def test_fill_column_85(generator, reference_report):
...
def test_fill_column_86(generator, reference_report):
...
def test_fill_column_87(generator, reference_report):
...
def test_fill_column_88(generator, reference_report):
...
def test_fill_column_89(generator, reference_report):
...
def test_fill_column_90(generator, reference_report):
...
def test_fill_column_91(generator, reference_report):
...
def test_fill_column_92(generator, reference_report):
...
def test_fill_column_93(generator, reference_report):
...
def test_fill_column_94(generator, reference_report):
...
def test_fill_column_94b(generator, reference_report):
...
def test_fill_column_95(generator, reference_report):
...
def test_fill_column_97(generator, reference_report):
...
def test_fill_column_98(generator, reference_report):
...
def test_fill_column_99(generator, reference_report):
...
def test_fill_column_100(generator, reference_report):
...
def test_fill_column_101(generator, reference_report):
...
def test_fill_column_102(generator, reference_report):
...
def test_fill_column_103(generator, reference_report):
...
def test_fill_column_104(generator, reference_report):
...
def test_fill_column_105(generator, reference_report):
...
def test_fill_column_105a(generator, reference_report):
...
def test_fill_column_105b(generator, reference_report):
...
def test_fill_column_106(generator, reference_report):
...
def test_fill_column_107(generator, reference_report):
...
def test_fill_column_108(generator, reference_report):
...
def test_fill_column_110(generator, reference_report):
...
def test_fill_column_111(generator, reference_report):
...
def test_fill_column_112(generator, reference_report):
...
def test_fill_column_113(generator, reference_report):
...
def test_fill_column_114(generator, reference_report):
...
def test_fill_column_115(generator, reference_report):

    generator.fill_column_115()

    prod = generator.report["115_Fund Issuer Code"].sort_index()
    ref = reference_report["115_Fund Issuer Code"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_116(generator, reference_report):

    generator.fill_column_116()

    prod = generator.report["116_Fund Issuer Code Type"].sort_index()
    ref = reference_report["116_Fund Issuer Code Type"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_117(generator, reference_report):

    generator.fill_column_117()

    prod = generator.report["117_Fund Issuer Name"].sort_index()
    ref = reference_report["117_Fund Issuer Name"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_118(generator, reference_report):

    generator.fill_column_118()

    prod = generator.report["118_Fund Issuer Sector"].sort_index()
    ref = reference_report["118_Fund Issuer Sector"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_119(generator, reference_report):

    generator.fill_column_119()

    prod = generator.report["119_Fund Issuer Group Code"].sort_index()
    ref = reference_report["119_Fund Issuer Group Code"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_120(generator, reference_report):

    generator.fill_column_120()

    prod = generator.report["120_Fund Issuer Group Code Type"].sort_index()
    ref = reference_report["120_Fund Issuer Group Code Type"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_121(generator, reference_report):

    generator.fill_column_121()

    prod = generator.report["121_Fund Issuer Group name"].sort_index()
    ref = reference_report["121_Fund Issuer Group name"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_122(generator, reference_report):

    generator.fill_column_122()

    prod = generator.report["122_Fund Issuer Country"].sort_index()
    ref = reference_report["122_Fund Issuer Country"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_123(generator, reference_report):

    generator.fill_column_123()

    prod = generator.report["123_Fund CIC code"].sort_index()
    ref = reference_report["123_Fund CIC code"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_123a(generator, reference_report):

    generator.fill_column_123a()

    prod = generator.report["123a_Fund Custodian Country"].sort_index()
    ref = reference_report["123a_Fund Custodian Country"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_124(generator, reference_report):

    generator.fill_column_124()

    prod = generator.report["124_Duration"].sort_index()
    ref = reference_report["124_Duration"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_125(generator, reference_report):

    generator.fill_column_125()

    prod = pd.to_numeric(generator.report["125_Accrued Income (Security Denominated Currency)"].sort_index()).round(5)
    ref = pd.to_numeric(reference_report["125_Accrued Income (Security Denominated Currency)"].sort_index()).round(5)
...
def test_fill_column_126(generator, reference_report):
...
def test_fill_column_127(generator, reference_report):
...
def test_fill_column_128(generator, reference_report):
...
def test_fill_column_129(generator, reference_report):
...
def test_fill_column_130(generator, reference_report):
...
def test_fill_column_131(generator, reference_report):
...
def test_fill_column_132(generator, reference_report):
...
def test_fill_column_133(generator, reference_report):

    generator.fill_column_133()

    prod = generator.report["133_custodian_name"].sort_index()
    ref = reference_report["133_custodian_name"].sort_index()

    assert_series_equal(prod, ref)

def test_fill_column_134(generator, reference_report):
...
def test_fill_column_135(generator, reference_report):
...
def test_fill_column_137(generator, reference_report):
